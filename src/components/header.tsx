...
import { List, X, ChevronDown, ChevronLeft, ChevronRight, Search } from 'lucide-react';
      ...
      <div className="wsj-main-header position-relative">
        <div className="container-fluid text-center py-2">
          ...
          <div className="edition-container d-none d-md-flex justify-content-center align-items-center mt-2 flex-wrap">
            ...
            <Link href="/" className="edition-link mx-2 mx-lg-3">Print Edition</Link>
            <div className="edition-divider d-none d-lg-block"></div>
            <Link href="/" className="edition-link mx-2 mx-lg-3">Video</Link>
            <div className="edition-divider d-none d-lg-block"></div>
            <Link href="/" className="edition-link mx-2 mx-lg-3 d-none d-md-block">Audio</Link>
            <div className="edition-divider d-none d-lg-block"></div>
            <Link href="/" className="edition-link mx-2 mx-lg-3 d-none d-lg-block">Latest Headlines</Link>
            <div className="edition-divider d-none d-lg-block"></div>
          ...
          <div className="auth-container position-absolute end-0 top-50 translate-middle-y me-2 d-none d-md-block">
            <Link href="/subscribe" className="btn btn-primary btn-sm btn-md-normal subscribe-btn me-1 me-md-2">Subscribe</Link>
            <Link href="/signin" className="btn btn-outline-dark btn-sm btn-md-normal signin-btn">Sign In</Link>
          </div>
        </div>
      </div>

      {/* Mobile menu - slides in when active */}
      <div className={`mobile-menu d-lg-none ${mobileMenuOpen ? 'open' : 'closed'}`} style={{
        position: 'fixed',
        top: 0,
        left: 0,
        width: '280px',
        ...
        <div className="p-2">
          ...
          <div className="mobile-auth-buttons d-flex justify-content-center gap-2 my-3">
            <Link href="/subscribe" className="btn btn-primary btn-sm flex-grow-1">Subscribe</Link>
            <Link href="/signin" className="btn btn-outline-dark btn-sm flex-grow-1">Sign In</Link>
          </div>
          ...
          <div className="mobile-nav-section mt-3">
            ...
            <div className="mobile-nav-items d-flex flex-column">
              <Link href="/" className="nav-link py-2 ps-2 border-bottom">Print Edition</Link>
              <Link href="/" className="nav-link py-2 ps-2 border-bottom">Video</Link>
              <Link href="/" className="nav-link py-2 ps-2 border-bottom">Audio</Link>
              <Link href="/" className="nav-link py-2 ps-2 border-bottom">Latest Headlines</Link>
            </div>
          </div>
          ...
          <div className="mobile-nav-section mt-3">
            ...
            <div className="mobile-nav-items d-flex flex-column">
              <Link href="/" className="nav-link py-2 ps-2 border-bottom">WSJ</Link>
              <Link href="/" className="nav-link py-2 ps-2 border-bottom">Barron's</Link>
              <Link href="/" className="nav-link py-2 ps-2 border-bottom">MarketWatch</Link>
              <Link href="/" className="nav-link py-2 ps-2 border-bottom">IBD</Link>
              <Link href="/" className="nav-link py-2 ps-2 border-bottom">Buy Side from WSJ</Link>
            </div>
          </div>
        </div>
      </div>
